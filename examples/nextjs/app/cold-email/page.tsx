...
export default function ColdEmailGeneratorPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const prompt = `
      Please write a professional cold email with the following details:
      - Recipient's Name: ${formData.recipientName || 'Not specified'}
      - Recipient's Title: ${formData.recipientTitle || 'Not specified'}
      - Recipient's Company: ${formData.recipientCompany || 'Not specified'}
      - Sender's Name: ${formData.senderName || 'Not specified'}
      - Sender's Title: ${formData.senderTitle || 'Not specified'}
      - Sender's Company: ${formData.senderCompany || 'Not specified'}
      - Purpose of Email: ${formData.purpose || 'To introduce our services.'}
      - Key Value Proposition: ${formData.valueProposition || 'We provide excellent solutions.'}
      - Personalization Point: ${formData.personalization || 'I was impressed by your company.'}
    `;
